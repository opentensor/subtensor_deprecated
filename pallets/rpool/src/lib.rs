...
pub mod pallet {
	...
	pub trait Config: frame_system::Config {
		...
		/// Debug is on
		#[pallet::constant]
		type RpoolSDebug: Get<u64>;

		/// Rho constant
		#[pallet::constant]
		type RpoolInitialRho: Get<u64>;

		/// Kappa constant
		#[pallet::constant]
		type RpoolInitialKappa: Get<u64>;

		/// Default Batch size.
		#[pallet::constant]
		type RpoolInitialValidatorBatchSize: Get<u64>;

		/// Default Batch size.
		#[pallet::constant]
		type RpoolInitialValidatorSequenceLen: Get<u64>;

		/// Default Epoch length.
		#[pallet::constant]
		type RpoolInitialValidatorEpochLen: Get<u64>;

		/// Default Reset length.
		#[pallet::constant]
		type RpoolInitialValidatorEpochsPerReset: Get<u64>;

		/// Max UID constant.
		#[pallet::constant]
		type RpoolInitialMaxAllowedUids: Get<u64>;

		/// Initial min allowed weights.
		#[pallet::constant]
		type RpoolInitialMinAllowedWeights: Get<u64>;

		/// Initial allowed max min weight ratio
		#[pallet::constant]
		type RpoolInitialMaxAllowedMaxMinRatio: Get<u64>;

		/// Initial stake pruning denominator
		#[pallet::constant]
		type RpoolInitialStakePruningDenominator: Get<u64>;

		/// Initial incentive pruning denominator
		#[pallet::constant]
		type RpoolInitialIncentivePruningDenominator: Get<u64>;

		/// Initial foundation distribution
		#[pallet::constant]
		type RpoolInitialFoundationDistribution: Get<u64>;

		/// Immunity Period Constant.
		#[pallet::constant]
		type RpoolInitialImmunityPeriod: Get<u64>;

		/// Blocks per step.
		#[pallet::constant]
		type RpoolInitialBlocksPerStep: Get<u64>;

		/// Blocks per era.
		#[pallet::constant]
		type RpoolInitialBondsMovingAverage: Get<u64>;
		
		/// SelfOwnership constant
		#[pallet::constant]
		type RpoolSelfOwnership: Get<u64>;

		/// Activity constant
		#[pallet::constant]
		type RpoolInitialActivityCutoff: Get<u64>;

		/// Initial registration difficulty.
		#[pallet::constant]
		type RpoolInitialIssuance: Get<u64>;

		/// Initial registration difficulty.
		#[pallet::constant]
		type RpoolInitialDifficulty: Get<u64>;

		/// Minimum registration difficulty
		#[pallet::constant]
		type RpoolMinimumDifficulty: Get<u64>;

		/// Maximum registration difficulty
		#[pallet::constant]
		type RpoolMaximumDifficulty: Get<u64>;

		/// Initial adjustment interval.
		#[pallet::constant]
		type RpoolInitialAdjustmentInterval: Get<u64>;

		/// Initial max registrations per block.
		#[pallet::constant]
		type RpoolInitialMaxRegistrationsPerBlock: Get<u64>;

		/// Initial target registrations per interval.
		#[pallet::constant]
		type RpoolInitialTargetRegistrationsPerInterval: Get<u64>;
	}
	...
	#[pallet::type_value] 
	pub fn DefaultRho<T: Config>() -> u64 { T::RpoolInitialRho::get() }
	#[pallet::storage]
	...
	#[pallet::type_value] 
	pub fn DefaultKappa<T: Config>() -> u64 { T::RpoolInitialKappa::get() }
	#[pallet::storage]
	...
	#[pallet::type_value] 
	pub fn DefaultIncentivePruningDenominator<T: Config>() -> u64 { T::RpoolInitialIncentivePruningDenominator::get() }
	#[pallet::storage]
	...
	#[pallet::type_value] 
	pub fn DefaultStakePruningDenominator<T: Config>() -> u64 { T::RpoolInitialStakePruningDenominator::get() }
	#[pallet::storage]
	...
	#[pallet::type_value] 
	pub fn DefaultValidatorEpochLen<T: Config>() -> u64 { T::RpoolInitialValidatorEpochLen::get() }
	#[pallet::storage]
	...
	#[pallet::type_value] 
	pub fn DefaultValidatorEpochsPerReset<T: Config>() -> u64 { T::RpoolInitialValidatorEpochsPerReset::get() }
	#[pallet::storage]
	...
	#[pallet::type_value] 
	pub fn DefaultValidatorBatchSize<T: Config>() -> u64 { T::RpoolInitialValidatorBatchSize::get() }
	#[pallet::storage]
	...
	#[pallet::type_value] 
	pub fn DefaultValidatorSequenceLen<T: Config>() -> u64 { T::RpoolInitialValidatorSequenceLen::get() }
	#[pallet::storage]
	...
	#[pallet::type_value] 
	pub fn DefaultMaxAllowedUids<T: Config>() -> u64 { T::RpoolInitialMaxAllowedUids::get() }
	#[pallet::storage]
	...
	#[pallet::type_value] 
	pub fn DefaultMinAllowedWeights<T: Config>() -> u64 { T::RpoolInitialMinAllowedWeights::get() }
	#[pallet::storage]
	...
	#[pallet::type_value] 
	pub fn DefaultMaxAllowedMaxMinRatio<T: Config>() -> u64 { T::RpoolInitialMaxAllowedMaxMinRatio::get() }
	#[pallet::storage]
	...
	#[pallet::type_value] 
	pub fn DefaultImmunityPeriod<T: Config>() -> u64 { T::RpoolInitialImmunityPeriod::get() }
	#[pallet::storage]
	...
	#[pallet::type_value] 
	pub fn DefaultTotalIssuance<T: Config>() -> u64 { T::RpoolInitialIssuance::get() }
	#[pallet::storage]
	...
	#[pallet::type_value] 
	pub fn DefaultBlocksPerStep<T: Config>() -> u64 { T::RpoolInitialBlocksPerStep::get() }
	#[pallet::storage]
	...
	#[pallet::type_value] 
	pub fn DefaultBondsMovingAverage<T: Config>() -> u64 { T::RpoolInitialBondsMovingAverage::get() }
	#[pallet::storage]
	...
	#[pallet::type_value] 
	pub fn DefaultDifficulty<T: Config>() -> u64 { T::RpoolInitialDifficulty::get() }
	#[pallet::storage]
	...
	#[pallet::type_value] 
	pub fn DefaultActivityCutoff<T: Config>() -> u64 { T::RpoolInitialActivityCutoff::get() }
	#[pallet::storage]
	...
	#[pallet::type_value] 
	pub fn DefaultAdjustmentInterval<T: Config>() -> u64 { T::RpoolInitialAdjustmentInterval::get() }
	#[pallet::storage]
	...
	#[pallet::type_value] 
	pub fn DefaultTargetRegistrationsPerInterval<T: Config>() -> u64 { T::RpoolInitialTargetRegistrationsPerInterval::get() }
	#[pallet::storage]
	...
	#[pallet::type_value] 
	pub fn DefaultMaxRegistrationsPerBlock<T: Config>() -> u64 { T::RpoolInitialMaxRegistrationsPerBlock::get() }
	#[pallet::storage]
	...
	#[pallet::type_value] 
	pub fn DefaultFoundationDistribution<T: Config>() -> u64 { T::RpoolInitialFoundationDistribution::get() }
	#[pallet::storage]
	...
	impl<T: Config> Pallet<T> {
		...
		pub fn get_minimum_difficulty( ) -> u64 {
			return T::RpoolMinimumDifficulty::get();
		}
		// -- Maximum difficulty
		pub fn get_maximum_difficulty( ) -> u64 {
			return T::RpoolMaximumDifficulty::get();
		}
		// -- Get Block emission.
		...
		pub fn get_self_ownership( ) -> u64 {
			return T::RpoolSelfOwnership::get();
		}
		...
		pub fn get_initial_total_issuance( ) -> u64 {
			return T::RpoolInitialIssuance::get();
		}
		...
		// --- Returns the next neuron to promote.
		pub fn get_promotion() -> bool {
			true
		}
